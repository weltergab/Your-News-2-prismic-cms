  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        color: {
          'btn5': '#0E2A47', // botões principais, textos de destaque e links que precisam se destacar
          'btn2': '#485B39', // botões secundários, elementos de navegação e detalhes que precisam se destacar sem serem tão intensos
          'bg': '#11172B', // bg
          'bg2': '#D8D8D8', // fundos dos elementos de conteúdo
          ...
          'texto': '#FFFFFF', // texto principal e o fundo de elementos de destaque
