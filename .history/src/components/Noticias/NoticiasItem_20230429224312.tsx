...
export function NoticiasItem() {
  return (
    ...
    <div className="bg-paletaDark-300 my-3 items-center flex flex-row h-32 md:h-40 mx-3 max-w-4xl">
      ...
      <div className="h-full w-4/6 px-6 border-8 border-paletaDark-300 by-5 overflow-hidden flex flex-col relative">
