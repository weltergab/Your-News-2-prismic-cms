  ...
  return (
    <>
      <div className="flex flex-col items-center">
        ...
        <div className="bg-gray-500 max-w-7xl h-64 p-8 m-8 flex justify-center items-center flex-col">

          <div className="w-2/5 p-5 border-blue-200 border bg-green-300 relative overflow-hidden">
