...
export function NoticiasItem() {
  return (
    ...
    <div className="bg-gray-500 my-3 items-center flex flex-row h-32 w-screen">
      ...
      <div className="h-full w-3/5 px-6 py-2 overflow-hidden flex items-center justify-center">
        <h2 className="text-white font-medium">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</h2>
      </div>
    </div>
    </Link>
  );
