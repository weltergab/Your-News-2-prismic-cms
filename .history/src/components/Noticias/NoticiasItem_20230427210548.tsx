...
export function NoticiasItem() {
  return (
    ...
    <div className="bg-gray-500 my-3 items-center flex flex-row w-auto h-32 mx-3">
      <div className="h-full w-1/6 border-blue-200 bg-green-300 relative overflow-hidden">
        <Image
          src="/vert.jpg"
          alt="Minha imagem"
          fill
      ...
      <div className="h-full w-5/6 px-6 py-3 overflow-hidden flex">
