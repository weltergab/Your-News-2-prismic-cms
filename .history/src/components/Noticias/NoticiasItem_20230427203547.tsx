...
export function NoticiasItem() {
  return (
    <div className="bg-gray-500 my-3 items-center flex flex-row h-32 w-full">
      <div className="h-max w-2/5 border-blue-200 bg-green-300 relative overflow-hidden">
        <Image
          src="/vert.jpg"
          alt="Minha imagem"
          fill
      ...
      <div className="w-3/5 px-1 overflow-hidden">
