  ...
  return (
    <>
      <div className="flex flex-col items-center">
        ...
        <div className="bg-gray-500 max-w-7xl h-screen sm:h-64 p-8 m-8 justify-center items-center flex flex-row">

          <div className="w-full sm:w-2/5 h-full border-blue-200 border bg-green-300 relative overflow-hidden">
            <Image
              src="/vert.jpg"
              alt="Minha imagem"
              fill
