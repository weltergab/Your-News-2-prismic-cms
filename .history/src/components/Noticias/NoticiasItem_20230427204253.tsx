  ...
  return (
    <div className="bg-gray-500 my-3 items-center flex flex-row h-32 w-screen">
      ...
      <div className="h-full w-3/5 px-6 py-2 overflow-hidden">
        <h2 className="font-bold text-white">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rerum ratione sed reprehenderit accusamus? Ullam porro mollitia esse animi fuga, at veritatis a dolor id vel eaque totam nihil aliquam iste?</h2>
      </div>
    </div>
  );
}
