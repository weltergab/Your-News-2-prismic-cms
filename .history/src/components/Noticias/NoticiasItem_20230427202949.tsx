...
export function NoticiasItem() {
  return (
    <div className="bg-gray-500 my-10 items-center w-2/6 flex flex-col h-screen
                                              sm:m-8 sm:h-max sm:w-full sm:flex-row">
      <div className="w-screen w-2/5 border-blue-200 bg-green-300 relative overflow-hidden">
        <Image
          src="/vert.jpg"
          alt="Minha imagem"
          fill
      ...
      <div className="w-screen w-3/5 px-8 overflow-hidden">
