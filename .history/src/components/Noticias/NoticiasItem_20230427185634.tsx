...
export function NoticiasItem() {
  return (
    <div className="bg-gray-500 my-10 sm:m-8 sm:p-1 items-center
                        flex flex-col h-screen sm:h-64 sm:flex-row">
      <div className="w-screen h-full sm:w-1/5 border-blue-200 border bg-green-300 relative overflow-hidden">
        <Image
          src="/vert.jpg"
          alt="Minha imagem"
          fill
