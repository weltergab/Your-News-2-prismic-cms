  ...
  return (
    ...
    <div className="bg-gray-500 my-3 items-center flex flex-row h-32 w-screen">
      ...
      <div className="h-full w-3/5 px-6 py-3 overflow-hidden flex">
        <h2 className="text-white font-medium">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod voluptatum vitae dolorum officia cum dolores enim in modi distinctio porro?</h2>
      </div>
    </div>
    </Link>
  );
