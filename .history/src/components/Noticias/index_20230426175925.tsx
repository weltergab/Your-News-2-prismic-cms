  ...
  return (
    <>
      <div className="flex flex-col items-center">
        ...
        <div className=" w-7xl max-w-2xl h-64 p-8 m-8 justify-center items-center flex flex-col sm:flex-row">

          <div className="w-2/5 h-full border-blue-200 border bg-green-300 relative overflow-hidden bg-gray-500">
