  ...
  return (
    <div className='bg-blue-700 bg-center bg-cover bg-no-repeat min-h-screen items-center flex flex-col'>
      ...
      <div className="bg-gray-500 items-center flex flex-col mt-8 w-full">
        ...
        <div className="h-auto p-12 ml-5 px-6 flex flex-col relative">
          <h1 className="text-white font-medium pb-16 text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod voluptatum vitae dolorum officia</h1>
