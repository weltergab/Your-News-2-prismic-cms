...
function NoticiaFull() {
  ...
  return (
    <div className='bg-blue-700 bg-center bg-cover bg-no-repeat min-h-screen items-center flex flex-col'>
      ...
      <h1>Noticia Full</h1>
      <div className="bg-gray-500 items-center flex flex-col mt-8 w-full md:max-w-4/6">
        ...
        <div className="h-auto py-6 mx-3 px-6 flex flex-col relative">
          <h1 className="text-white font-medium pb-20 text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod voluptatum vitae dolorum officia</h1>
