...
function NoticiaFull() {
  ...
  return (
    <div className='bg-color-bg2 bg-center bg-cover bg-no-repeat min-h-screen items-center flex flex-col'>

      <h1>Noticia Full</h1>
      <div className="bg-color-bg2 items-center flex flex-col mt-8 w-full max-w-5xl">
